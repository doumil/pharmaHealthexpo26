...
class MainDay12Screen extends StatefulWidget {
  const MainDay12Screen({Key? key}) : super(key: key);

  @override
  _MainDay12ScreenState createState() => _MainDay12ScreenState();
}

class _MainDay12ScreenState extends State<MainDay12Screen> {
  ...
  _loadData() async {
    ...
    //.toList();
    //litems=prod;
    var prod1=CongressDClass("CONFERENCE 12 september","Adaptive Soc Services","10:00","12:00");
    litems.add(prod1);
    if (this.mounted) {
      setState(() {
        isLoading = false;
