...
class MainDay13Screen extends StatefulWidget {
  const MainDay13Screen({Key? key}) : super(key: key);

  @override
  _MainDay13ScreenState createState() => _MainDay13ScreenState();
}

class _MainDay13ScreenState extends State<MainDay13Screen> {
  ...
  _loadData() async {
    ...
    //.toList();
    //litems=prod;
    var prod1=CongressDClass("CONFERENCE 13 september","Adaptive Soc Services","10:00","12:00");
    litems.add(prod1);
    if (this.mounted) {
      setState(() {
        isLoading = false;
