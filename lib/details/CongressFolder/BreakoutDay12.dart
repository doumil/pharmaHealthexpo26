...
class BreakoutDay12Screen extends StatefulWidget {
  const BreakoutDay12Screen({Key? key}) : super(key: key);

  @override
  _BreakoutDay12ScreenState createState() => _BreakoutDay12ScreenState();
}

class _BreakoutDay12ScreenState extends State<BreakoutDay12Screen> {
  ...
  _loadData() async {
    ...
    //.toList();
    //litems=prod;
    var prod1=CongressDClass("vip lounge 12 september","Adaptive Soc Services","10:00","12:00");
    litems.add(prod1);
    if (this.mounted) {
      setState(() {
        isLoading = false;
